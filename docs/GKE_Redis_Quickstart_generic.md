...
## 1. Optimized Redis 7 - C4 Standard
...
## 2. Valkey 8 Baseline - N2 Standard
...
## 3. Redis 7 Baseline (C4 Standard) - 1:1 with AOF
...
# Redis HA  Execution Reference

## 4. Redis 7 HA Optimized - C4 Standard (0:1 - 100% Reads)
